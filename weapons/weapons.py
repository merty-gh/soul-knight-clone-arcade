...
class Pistol(RangedWeapon):
    def __init__(self):
        # Используем ТОЧКУ (маленький метеорит), чтобы не было линий
        super().__init__(damage=10, cooldown=0.5, bullet_image=":resources:images/space_shooter/meteorGrey_tiny1.png")
